...
`e:\公众号内容生成\小红书内容生成\crawler\.env`

## Usage

```bash
python e:\公众号内容生成\公众号内容生成\scripts\wechat_image_generator.py \
  e:\公众号内容生成\公众号内容生成\生成内容\2026-01-29\ipgc-20260129-底层戾气.md
```

Optional:
```bash
python e:\公众号内容生成\公众号内容生成\scripts\wechat_image_generator.py <md_file> --model 2.5-pro --limit 2
```

## Output
Images are saved under:
```
生成内容/<DATE>/images/<账号缩写>/
```
...
```bash
python e:\公众号内容生成\公众号内容生成\scripts\wechat_image_generator.py --batch-date 2026-01-29
```
Retries:
```bash
python e:\公众号内容生成\公众号内容生成\scripts\wechat_image_generator.py <md_file> --retries 2
```
Logs:
```
生成内容/<DATE>/images/<账号缩写>/run.log
```
